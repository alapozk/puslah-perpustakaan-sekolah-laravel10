...
<head>
    ...
    <title>Sistem Informasi Perpustakaan TUBI</title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="container mx-auto">
            ...
            <div class="flex flex-col items-center mt-16">
                <h1 class="text-3xl font-semibold mb-6 text-center text-gray-800 dark:text-white">Selamat datang di Sistem Informasi Perpustakaan TUBI</h1>
